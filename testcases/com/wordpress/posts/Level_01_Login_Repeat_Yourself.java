...
public class Level_01_Login_Repeat_Yourself {
	...
	public void Login_02_Invalid_Email() {
		...
		String userNotExistMsg= driver.findElement(By.xpath("//div[@class='form-input-validation is-error']")).getText().trim();		
		Assert.assertEquals(userNotExistMsg, "User does not exist. Would you like to create a new account?");
		
		Assert.assertTrue(driver.findElement(By.xpath("//div[@class='form-input-validation is-error' "
				+ "and contains(string(),'User does not exist.create a new account?')]")).isDisplayed());	
	...
	public void Login_04_Empty_Password() {
		driver.findElement(usernameTb).sendKeys("automationediter");
		driver.findElement(continueBtn).click();
	...
	public void Login_07_Valid_Email_P() {
		driver.findElement(usernameTb).sendKeys("automationediter");
		driver.findElement(continueBtn).click();
		driver.findElement(passTb).sendKeys("automationfb");		
		driver.findElement(loginBtn).click();
